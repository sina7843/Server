...
describe('OtpChallengeService', () => {
  ...
  function createChallenge(overrides: Partial<OtpChallengeState> = {}): OtpChallengeState {
    return {
      attempts: 0,
  ...
  it('calculates resend cooldown correctly', () => {
    ...
    expect(service.calculateNextResendAt(90, now)).toEqual(new Date('2026-01-01T00:01:30.000Z'));
  });
