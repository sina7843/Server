<template>
  <main class="content-page">
    <div class="content-page__header">
      <span class="dr-label">Guides</span>
      <h1 class="content-page__title">راهنماها</h1>
    </div>
...
const { data, pending, error } = await useAsyncData('guides-list', () => content.listGuides());

const siteName = (runtimeConfig.public?.siteName as string | undefined) ?? 'Dragon';
useHead({ title: `راهنماها — ${siteName}` });
</script>
