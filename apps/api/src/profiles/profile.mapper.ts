...
export function toMyUserProfileDto(profile: UserProfileLike): MyUserProfileDto {
  return {
...
export function toPublicUserProfileDto(profile: UserProfileLike): PublicUserProfileDto {
  return {
    username: profile.username,
    displayName: profile.displayName,
    ...(profile.avatarMediaId !== undefined
