...
| ------ | ---------------------------------------- | ------ | ---------- | -------------------------- | --------------------------- | --------------------------------------------------- |
| POST   | `/api/v1/auth/register`                  | —      | —          | `{ phone }`                | `AuthGenericResponseDto`    | Sends OTP; phone must be E.164                      |
...
| POST   | `/api/v1/auth/refresh`                   | —      | —          | `{ refreshToken }`         | `TokenResponseDto`          | Rotates tokens                                      |
...
| POST   | `/api/v1/auth/password/reset`            | —      | —          | `{ resetToken, password }` | `AuthGenericResponseDto`    | Sets new password; invalidates reset token          |
